...
void main() {
  ...
  testWidgets(
    ...
    await tester.pumpWidget(_makeTestableWidget(TvSeriesDetailPage(id: 1399)));
  ...
  testWidgets(
      'Recommendation should display CircularProgressIndicator when loading',
      (WidgetTester tester) async {
    when(mockNotifier.tvSeriesState).thenReturn(RequestState.Loaded);
    when(mockNotifier.tvSeries).thenReturn(testTvSeriesDetail);
  ...
  testWidgets('Recommendation should display error message when error',
      (WidgetTester tester) async {
    when(mockNotifier.tvSeriesState).thenReturn(RequestState.Loaded);
    when(mockNotifier.tvSeries).thenReturn(testTvSeriesDetail);
  ...
  testWidgets('Season list should be displayed when tv series is loaded',
      (WidgetTester tester) async {
    when(mockNotifier.tvSeriesState).thenReturn(RequestState.Loaded);
    when(mockNotifier.tvSeries).thenReturn(testTvSeriesDetail);
    when(mockNotifier.recommendationState).thenReturn(RequestState.Loaded);
  ...
  testWidgets('Should show episode bottom sheet when season is tapped',
      (WidgetTester tester) async {
    when(mockNotifier.tvSeriesState).thenReturn(RequestState.Loaded);
    when(mockNotifier.tvSeries).thenReturn(testTvSeriesDetail);
    when(mockNotifier.recommendationState).thenReturn(RequestState.Loaded);
    ...
    await tester.drag(
        find.byKey(Key('tv_series_detail_scroll')), const Offset(0, -300));
    await tester.pump();
